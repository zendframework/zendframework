...
class ZF
{
     ...
     *
     * @param boolean $mustExist      Should the returned value already exist in the file system
     * @param boolean $returnMessages Should it log messages for output later
     * @return string
     */
