 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ShMem extends ZendServer implements \Zend\Cache\Backend\BackendInterface
{
    /**
     * Constructor
     *
    ...
    public function __construct(array $options = array())
    {
        if (!function_exists('zend_shm_cache_store')) {
            \Zend\Cache\Cache::throwException('Zend_Cache_ZendServer_ShMem backend has to be used within Zend Server environment.');
        }
