...
abstract class AbstractAdapter
{
     ...
     * @var string
     */
    protected $_defaultProfilerClass = '\Zend\DB\Profiler\Profiler';
    ...
    public function setProfiler($profiler)
    {
        ...
        if ($profilerIsObject = is_object($profiler)) {
            if ($profiler instanceof Profiler\Profiler) {
...
//            }
        ...
        if (!$profilerInstance instanceof Profiler\Profiler) {
     ...
     *
     * @return \Zend\DB\Profiler\Profiler
     */
    ...
    {
        $this->_connect();
        $q = $this->_profiler->queryStart('begin', Profiler\Profiler::TRANSACTION);
    ...
    {
        $this->_connect();
        $q = $this->_profiler->queryStart('commit', Profiler\Profiler::TRANSACTION);
        $this->_commit();
        $this->_profiler->queryEnd($q);
        return $this;
    }
    ...
    {
        $this->_connect();
        $q = $this->_profiler->queryStart('rollback', Profiler\Profiler::TRANSACTION);
        $this->_rollBack();
        $this->_profiler->queryEnd($q);
        return $this;
    }
