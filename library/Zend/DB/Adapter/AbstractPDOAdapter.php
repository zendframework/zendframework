 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class AbstractPDOAdapter extends Adapter\AbstractAdapter
{
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('pdo')) {
            throw new Adapter\Exception('The PDO extension is required for this adapter but the extension is not loaded');
        }

        // check the PDO driver is available
        if (!in_array($this->_pdoType, \PDO::getAvailableDrivers())) {
            throw new Adapter\Exception('The ' . $this->_pdoType . ' driver is not currently installed');
        }

        // create PDO connection
        $q = $this->_profiler->queryStart('connect', \Zend\DB\Profiler\Profiler::CONNECT);
    ...
    public function exec($sql)
    {
        ...
        try {
            ...
            if ($affected === false) {
                ...
                throw new Adapter\Exception($errorInfo[2]);
            }
    ...
    public function setFetchMode($mode)
    {
        ...
        switch ($mode) {
            ...
            case \PDO::FETCH_OBJ:
                ...
                break;
            default:
                throw new Adapter\Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
