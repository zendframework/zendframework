...
class Profiler
{
     ...
     * @return \Zend\DB\Profiler\Profiler Provides a fluent interface
     */
     ...
     * @param  integer $queryType   OPTIONAL Type of query, one of the \Zend\DB\Profiler\Profiler::* constants
     * @return integer|null
     */
    public function queryStart($queryText, $queryType = null)
    {
        ...
        $this->_queryProfiles[] = new Query($queryText, $queryType);
    ...
    public function queryEnd($queryId)
    {
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
            throw new Exception("Profiler has no query with handle '$queryId'.");
        }
        ...
        if ($qp->hasEnded()) {
            throw new Exception("Query with profiler handle '$queryId' has already ended.");
        }
    ...
    public function getQueryProfile($queryId)
    {
        if (!array_key_exists($queryId, $this->_queryProfiles)) {
            throw new Exception("Query handle '$queryId' not found in profiler log.");
        }
