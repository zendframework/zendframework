...
class Select
{
     ...
     */
    public function __construct(DB\Adapter\AbstractAdapter $adapter)
    {
     ...
     *
     * @param  array|string|\Zend\DB\Expr $name The table name.
     ...
     * @param string $part
     * @return mixed
     * @throws \Zend\DB\Select\Exception
     */
     ...
     * @param  array|string|\Zend\DB\Expr $name Table name
     * @param  string $cond Join on this condition
     * @param  array|string $cols The columns to select from the joined table
     * @param  string $schema The database name to specify, if any.
     * @return \Zend\DB\Select\Select This \Zend\DB\Select\Select object
    ...
    protected function _join($type, $name, $cond, $cols, $schema = null)
    {
        ...
        } else if ($name instanceof DB\Expr|| $name instanceof Select) {
            $tableName = $name;
     ...
     * @return \Zend\DB\Select\Select
     * @throws \Zend\DB\Select\Exception If an invalid method is called.
     */
