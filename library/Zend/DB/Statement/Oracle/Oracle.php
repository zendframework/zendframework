 ...
 * @uses       \Zend\DB\Statement\Oracle\Exception
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Statement
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Oracle extends DB\Statement\Statement
{
     ...
     * @param string $sql
     * @return void
     * @throws \Zend\DB\Statement\Oracle\Exception
     */
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            throw new Exception(oci_error($connection));
        }
    }
    ...
    protected function _bindParam($parameter, &$variable, $type = null, $length = null, $options = null)
    {
        ...
        if ($retval === false) {
            throw new Exception(oci_error($this->_stmt));
        }
