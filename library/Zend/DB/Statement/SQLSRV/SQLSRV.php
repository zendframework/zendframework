 ...
 * @namespace
 */
namespace Zend\DB\Statement\SQLSRV;
use Zend\DB;
 ...
 * @uses       \Zend\DB\Statement\SQLSRV\Exception
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Statement
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SQLSRV extends DB\Statement\Statement
{
    ...
    public function getColumnMeta($column)
    {
        ...
        if (!$fields) {
            throw new Exception('Column metadata can not be fetched');
        }

        if (!isset($fields[$column])) {
            throw new Exception('Column index does not exist in statement');
        }
