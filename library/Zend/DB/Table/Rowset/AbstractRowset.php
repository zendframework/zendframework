...
/**
 * @uses       \Zend\DB\Table\Rowset\Exception
 * @uses       \Zend\Loader
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Table
...
abstract class AbstractRowset implements \SeekableIterator, \Countable, \ArrayAccess
{
     ...
     */
    public function setTable(\Zend\DB\Table\AbstractTable $table)
    {
        $this->_table = $table;
        $this->_connected = false;
     ...
     *
     * @return \Zend\DB\Table\Rowset\AbstractRowset Fluent interface.
     */
     ...
     * Required by interface Iterator.
     *
     * @return \Zend\DB\Table\Row\AbstractRow current element from the collection
     */
     ...
     * @throws \Zend\DB\Table\Rowset\Exception
     */
