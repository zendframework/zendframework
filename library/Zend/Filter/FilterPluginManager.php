...
class FilterPluginManager extends AbstractPluginManager
{
    ...
    protected $aliases = array(
        // Ensure we can pull by class name
        'zendfilteralnum'                     => 'alnum',
        'zendfilteralpha'                     => 'alpha',
        'zendfilterbasename'                  => 'basename',
        'zendfilterboolean'                   => 'boolean',
        'zendfiltercallback'                  => 'callback',
        'zendfiltercompress'                  => 'compress',
        'zendfiltercompressbz2'               => 'compressbz2',
        'zendfiltercompressgz'                => 'compressgz',
        'zendfiltercompresslzf'               => 'compresslzf',
        'zendfiltercompressrar'               => 'compressrar',
        'zendfiltercompresstar'               => 'compresstar',
        'zendfiltercompresszip'               => 'compresszip',
        'zendfilterdecompress'                => 'decompress',
        'zendfilterdecrypt'                   => 'decrypt',
        'zendfilterdigits'                    => 'digits',
        'zendfilterdir'                       => 'dir',
        'zendfilterencrypt'                   => 'encrypt',
        'zendfilterencryptmcrypt'             => 'encryptmcrypt',
        'zendfilterencryptopenssl'            => 'encryptopenssl',
        'zendfilterencryptopenssl'            => 'encrypt_openssl',
        'zendfilterfiledecrypt'               => 'filedecrypt',
        'zendfilterfileencrypt'               => 'fileencrypt',
        'zendfilterfilelowercase'             => 'filelowercase',
        'zendfilterfilerename'                => 'filerename',
        'zendfilterfileuppercase'             => 'fileuppercase',
        'zendfilterhtmlentities'              => 'htmlentities',
        'zendfilterinflector'                 => 'inflector',
        'zendfilterint'                       => 'int',
        'zendfilterlocalizedtonormalized'     => 'localizedtonormalized',
        'zendfilternormalizedtolocalized'     => 'normalizedtolocalized',
        'zendfilternull'                      => 'null',
        'zendfilterpregreplace'               => 'pregreplace',
        'zendfilterrealpath'                  => 'realpath',
        'zendfilterstringtolower'             => 'stringtolower',
        'zendfilterstringtoupper'             => 'stringtoupper',
        'zendfilterstringtrim'                => 'stringtrim',
        'zendfilterstripnewlines'             => 'stripnewlines',
        'zendfilterstriptags'                 => 'striptags',
        'zendfilterwordcamelcasetodash'       => 'wordcamelcasetodash',
        'zendfilterwordcamelcasetoseparator'  => 'wordcamelcasetoseparator',
        'zendfilterwordcamelcasetounderscore' => 'wordcamelcasetounderscore',
        'zendfilterworddashtocamelcase'       => 'worddashtocamelcase',
        'zendfilterworddashtoseparator'       => 'worddashtoseparator',
        'zendfilterworddashtounderscore'      => 'worddashtounderscore',
        'zendfilterwordseparatortocamelcase'  => 'wordseparatortocamelcase',
        'zendfilterwordseparatortodash'       => 'wordseparatortodash',
        'zendfilterwordseparatortoseparator'  => 'wordseparatortoseparator',
        'zendfilterwordunderscoretocamelcase' => 'wordunderscoretocamelcase',
        'zendfilterwordunderscoretodash'      => 'wordunderscoretodash',
        'zendfilterwordunderscoretoseparator' => 'wordunderscoretoseparator',
    );
