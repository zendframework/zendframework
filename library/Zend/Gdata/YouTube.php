 ...
 * @uses       Zend_Gdata_YouTube_ActivityFeed
 * @uses       Zend_Gdata_YouTube_CommentFeed
 * @uses       Zend_Gdata_YouTube_ContactFeed
 * @uses       Zend_Gdata_YouTube_InboxFeed
 * @uses       Zend_Gdata_YouTube_PlaylistListFeed
 * @uses       Zend_Gdata_YouTube_PlaylistVideoFeed
 * @uses       Zend_Gdata_YouTube_SubscriptionFeed
 * @uses       Zend_Gdata_YouTube_VideoEntry
 * @uses       Zend_Gdata_YouTube_VideoFeed
 * @category   Zend
 * @package    Zend_Gdata
 * @subpackage YouTube
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
