...
class PDFDocument
{
    ...
    {
        return new PDFDocument($source, $revision, true);
    }
    ...
    public function __construct($source = null, $revision = null, $load = false)
    {
        ...
        if ($source !== null) {
            ...
            $this->_pdfHeaderVersion = PDFDocument::PDF_VERSION;
            ...
            $docCatalog->Version  = new InternalType\NameObject(PDFDocument::PDF_VERSION);
