 ...
 * @uses       Zend_Pdf_ElementFactory_Proxy
 * @uses       Zend_Pdf_Element_Object
 * @uses       Zend_Pdf_Element_Object_Stream
 * @uses       Zend_Pdf_Exception
 * @uses       Zend_Pdf_UpdateInfoContainer
 * @package    Zend_Pdf
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
        return new Zend_Pdf_ElementFactory_Proxy(new self($objCount));
    }
