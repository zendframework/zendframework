...
class Lucene
{
    ...
    /**
     * Array of Zend\Search\Lucene\Index\SegmentInfo objects for current version of index.
     *
    ...
    private function _readPre21SegmentsFile()
    {
        ...
        for ($count = 0; $count < $segments; $count++) {
            ...
            $this->_segmentInfos[$segName] =
                                new Index\SegmentInfo($this->_directory,
                                                                         $segName,
                                                                         $segSize);
        }
    ...
    public function __construct($directory = null, $create = false)
    {
        ...
        if (is_string($directory)) {
            $this->_directory      = new Storage\Directory\Filesystem($directory);
    ...
    /**
     * Returns the Zend\Search\Lucene\Storage\Directory instance for this index.
     *
     ...
     * of Zend\Search\Lucene\Search\QueryHit objects.
     * Input is a string or Zend\Search\Lucene\Search\Query.
     *
    ...
    public function find($query)
    {
        ...
        if (!$query instanceof Search\Query) {
    ...
    /**
     * Returns a Zend\Search\Lucene\Document object for the document
    ...
    public function getDocument($id)
    {
        ...
        for ($count = 0; $count < $fieldCount; $count++) {
            ...
            if (!($bits & 2)) { // Text data
                $field = new Field($fieldInfo->name,
                                   $fdtFile->readString(),
                                   'UTF-8',
                                   true,
                                   $fieldInfo->isIndexed,
     ...
     * Zend\Search\Lucene\Index\DocsFilter object
     *
     * @param Zend\Search\Lucene\Index\Term $term
     * @param Zend\Search\Lucene\Index\DocsFilter|null $docsFilter
    ...
    {
        return Search\Similarity::getDefault();
    }
