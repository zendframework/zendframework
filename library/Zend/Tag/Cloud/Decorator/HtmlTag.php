 ...
 *
 * @uses      \Zend\Tag\Cloud\DecoratorInterface\Exception\InvalidArgumentException
 * @uses      \Zend\Tag\Cloud\DecoratorInterface\Tag
 * @category  Zend
 * @package   Zend_Tag
 * @uses      \Zend\Tag\Cloud\DecoratorInterface\Tag
 * @copyright Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
...
class HtmlTag extends Tag
{
     ...
     * @throws \Zend\Tag\Cloud\DecoratorInterface\Exception\InvalidArgumentException When the classlist is empty
     * @throws \Zend\Tag\Cloud\DecoratorInterface\Exception\InvalidArgumentException When the classlist contains an invalid classname
     * @return \Zend\Tag\Cloud\DecoratorInterface\HTMLTag
     */
     ...
     * @throws \Zend\Tag\Cloud\DecoratorInterface\Exception\InvalidArgumentException When an invalid fontsize unit is specified
     * @return \Zend\Tag\Cloud\DecoratorInterface\HTMLTag
     */
     ...
     * @throws \Zend\Tag\Cloud\DecoratorInterface\Exception\InvalidArgumentException When fontsize is not numeric
     * @return \Zend\Tag\Cloud\DecoratorInterface\HTMLTag
     */
    ...
    /**
     * Defined by Zend\Tag\Cloud\DecoratorInterface\Tag
     *
