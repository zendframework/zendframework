...
return array(
    ...
    "The input does not appear to be a valid datetime" => "Podana wartość nie jest datą",
    ...
    "An exception has been raised while validating the input" => "Wystąpił błąd podczas sprawdzania kodu pocztowego",
