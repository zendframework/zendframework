...
class McryptTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $options = 'test';
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The options parameter must be an array, a Zend\Config\Config object or a Traversable');
        $mcrypt = new Mcrypt($options);
    }
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The algorithm test is not supported by Zend\Crypt\Symmetric\Mcrypt');
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The key cannot be empty');
        $result = $this->mcrypt->setKey('');
    }
    
    public function testSetShortKey()
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The key is not long enough for the cipher');
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The size of the salt (IV) is not enough. You need 16 bytes');
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The mode xxx is not supported by Zend\Crypt\Symmetric\Mcrypt');
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','No key specified for the encryption');
        $ciphertext = $this->mcrypt->encrypt('test');
    }
    
    public function testEncryptEmptyData()
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException','The data to encrypt cannot be empty');
    ...
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException', 'The data to decrypt cannot be empty');
        $ciphertext = $this->mcrypt->decrypt('');
    }
    
    public function testDecryptWithoutKey()
    {
        $this->setExpectedException('Zend\Crypt\Symmetric\Exception\InvalidArgumentException', 'No key specified for the decryption');
