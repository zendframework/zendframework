...
abstract class AbstractTest extends \ZendTest\DB\TestSetup
{
    ...
    public function testProfilerPreparedStatement()
    {
        ...
        $qp = $profiles[0];
        $this->assertType('Zend\DB\Profiler\Query', $qp);
    ...
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler\Profiler::INSERT);
    }

    public function testProfilerSetFilterQueryTypeUpdate()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler\Profiler::UPDATE);
    }

    public function testProfilerSetFilterQueryTypeDelete()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler\Profiler::DELETE);
    }

    public function testProfilerSetFilterQueryTypeSelect()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler\Profiler::SELECT);
    }
