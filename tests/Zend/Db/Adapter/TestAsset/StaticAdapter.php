 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class StaticAdapter extends \Zend\Db\Adapter\AbstractAdapter
{
    public $config = null;
    ...
    protected function _checkRequiredOptions(array $config)
    {
        ...
        if (! array_key_exists('dbname', $config)) {
            throw new \Zend\Db\Adapter\Exception("Configuration must have a key for 'dbname' that names the database instance");
        }
        $this->config = $config;
    }
