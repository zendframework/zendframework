...
abstract class AbstractTest extends \ZendTest\Db\TestSetup
{
    ...
    public function testProfilerPreparedStatement()
    {
        ...
        $qp = $profiles[0];
        $this->assertInstanceOf('Zend\Db\Profiler\Query', $qp);
    ...
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler::INSERT);
    }

    public function testProfilerSetFilterQueryTypeUpdate()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler::UPDATE);
    }

    public function testProfilerSetFilterQueryTypeDelete()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler::DELETE);
    }

    public function testProfilerSetFilterQueryTypeSelect()
    {
        $this->_testProfilerSetFilterQueryTypeCommon(Profiler::SELECT);
    }
