...
class StaticTest extends \ZendTest\Db\TestSetup
{
    ...
    public function testProfilerFactoryFalse()
    {
        ...
        $prof = $db->getProfiler();
        $this->assertInstanceOf('Zend_Db_Profiler', $prof,
    ...
    public function testProfilerFactoryInstance()
    {
        ...
        $this->assertInstanceOf('Zend_Db_Profiler', $prof,
            'Expected object of type Zend_Db_Profiler, got ' . get_class($prof));
        $this->assertInstanceOf('Zend_Db_Profiler_ProfilerCustom', $prof,
    ...
    public function testProfilerQueryStart()
    {
        ...
        $queries = array(
            array(
                'sql'          => '',
                'typeGiven'    => null,
                'typeExpected' => Profiler::QUERY
                ),
            array(
                'sql'          => '',
                'typeGiven'    => Profiler::QUERY,
                'typeExpected' => Profiler::QUERY
                ),
            array(
                'sql'          => 'something',
            ...
            array(
                'sql'          => 'INSERT',
                'typeGiven'    => null,
                'typeExpected' => Profiler::INSERT
                ),
            array(
                'sql'          => 'sqlInsert',
                'typeGiven'    => Profiler::INSERT,
                'typeExpected' => Profiler::INSERT
                ),
            array(
                'sql'          => 'INSERT',
                'typeGiven'    => Profiler::UPDATE,
                'typeExpected' => Profiler::UPDATE
                ),
            array(
                'sql'          => 'UPDATE',
                'typeGiven'    => null,
            ...
            array(
                'sql'          => 'UPDATE',
                'typeGiven'    => Profiler::DELETE,
                'typeExpected' => Profiler::DELETE
                ),
            array(
                'sql'          => 'DELETE',
                'typeGiven'    => null,
            ...
            array(
                'sql'          => 'DELETE',
                'typeGiven'    => Profiler::SELECT,
                'typeExpected' => Profiler::SELECT
                ),
            array(
                'sql'          => 'SELECT',
                'typeGiven'    => null,
    ...
    public function testProfilerQueryEndFilterQueryType()
    {
        $prof = $this->_db->getProfiler()
                ->setEnabled(true)
                ->setFilterQueryType(Profiler::UPDATE);
    ...
    public function testProfilerGetTotalElapsedSecsFilterQueryType()
    {
        ...
        $this->assertThat(
            $prof->getTotalElapsedSecs(Profiler::SELECT),
            $this->lessThan(1)
            );

        $this->assertThat(
            $prof->getTotalElapsedSecs(Profiler::UPDATE),
