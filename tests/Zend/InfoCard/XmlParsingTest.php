...
class XmlParsingTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEncryptedDataType()
    {
            ...
            try {
                $encryptedData = EncryptedData\EncryptedData::getInstance($doc);
            ...
            try {
                $encryptedData = EncryptedData\EncryptedData::getInstance(10);
                $this->fail("Exception not thrown as expected");
            } catch(\Exception $e) {
                /* yay */
            }
    ...
    {
        $encryptedData = EncryptedData\EncryptedData::getInstance($this->_xmlDocument);
    ...
    {
        $keyinfo = EncryptedData\EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo();
    ...
    {
        $enckey = EncryptedData\EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo()->getEncryptedKey();
    ...
    {
        $keyinfo = EncryptedData\EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo()->getEncryptedKey()->getKeyInfo();
    ...
    {
        $sectoken = EncryptedData\EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo()
                                                                                      ->getEncryptedKey()
                                                                                      ->getKeyInfo()
