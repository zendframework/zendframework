...
class BcmathTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        // zero
        $this->assertEquals('0', $this->adapter->init('+0'));
        // decimal
        $this->assertEquals('1234567890', $this->adapter->init('+1234567890'));
        // octal
        $this->assertEquals('1234567890', $this->adapter->init('011145401322'));
        // hex
        $this->assertEquals('-1234567890', $this->adapter->init('-0x499602d2'));
        // scientific
        $this->assertEquals('1234567890', $this->adapter->init('1.23456789e+9'));
    }
