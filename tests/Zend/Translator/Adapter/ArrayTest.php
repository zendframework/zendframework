...
class ArrayTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreate()
    {
        ...
        try {
            $adapter = new Adapter\ArrayAdapter(dirname(__FILE__) . '/_files/failed.php', 'en');
            $this->fail('Exception expected');
        } catch (Translator\Exception $e) {
            $this->assertContains('Error including array or file', $e->getMessage());
        }
    ...
    {
        $adapter = new Adapter\ArrayAdapter(dirname(__FILE__) . '/_files/testarray', 'de_AT', array('scan' => Translator\Translator::LOCALE_DIRECTORY));
    ...
    {
        $adapter = new Adapter\ArrayAdapter(dirname(__FILE__) . '/_files/testarray', 'de_DE', array('scan' => Translator\Translator::LOCALE_FILENAME));
    ...
    {
        $adapter = new Adapter\ArrayAdapter(dirname(__FILE__) . '/_files/translation_en.php');
        $this->assertTrue($adapter instanceof Adapter\ArrayAdapter);
    }
