...
class SvgTest extends TestCommon
{
    ...
    {
        return new \Zend\Barcode\Renderer\Svg($options);
    }
    ...
    {
        \Zend\Barcode\Barcode::setBarcodeFont(__DIR__ . '/../Object/_fonts/Vera.ttf');
        $barcode = new \Zend\Barcode\Object\Code39(array('text' => '0123456789'));
